...
1. Clone the repo
- `git clone https://github.com/Aglena/books-history-api.git`

2. Run the API
- `dotnet restore`
- `dotnet run`

On startup the API uses seeding to insert initial data into the SQLite database.

3. Open Swagger UI to explore and try endpoints
